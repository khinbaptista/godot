...
public:
	...
	Vector<RasterizerStorageVK::RenderTarget::Exposure> exposure_shrink;
	...
	struct ReflectionProbeInstance : public RID_Data {
		...
		RasterizerStorageVK::ReflectionProbe *probe_ptr;
		RID probe;
		RID self;
		RID atlas;
	...
	virtual void environment_set_ssr(
			RID p_env, bool p_enable,
			int p_max_steps,
			float p_fade_int, float p_fade_out,
	...
	struct LightInstance : public RID_Data {
		...
		RID self;
		RID light;
		RasterizerStorageVK::Light *light_ptr;
		Transform transform;
	...
	struct GIProbeInstance : public RID_Data {
		RID data;
		RasterizerStorageVK::GIProbe *probe;
		//GLuint tex_cache;
	...
	struct RenderList {
		...
		struct Element {
			...
			RasterizerStorageVK::Geometry *geometry;
			RasterizerStorageVK::Material *material;
			RasterizerStorageVK::GeometryOwner *owner;
			uint64_t sort_key;
		};
	...
	/* bunch of inline functions not in part of the interface */
